...
if (isset($_GET['error'])) {
    ...
    elseif ($_GET['error'] == "invalidemailandusername") {
        echo '<p class="signuperror">Please enter a valid <strong>name</strong> and <strong>email</strong>.</br>Names can only contain letters and numbers</p>';
    }
    ...
    elseif ($_GET['error'] == "sqlerror") {
        echo '<p class="sqlsignuperror">Sorry, something went wrong.</p>';
    }
    elseif ($_GET['error'] == "sqlregerror") {
        echo '<p class="sqlsignuperror">Sorry, something wen wrong.</p>';
    }
    elseif ($_GET['error'] == "none") {
        echo '<p class="signupsuccess"> <strong>You Have Successfully Registered.</br>Welcome</strong></p>';
        }
}
//page css
include 'signup.html';
