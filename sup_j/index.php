...
<!--log in-->
        ...
        <div class="bb">
          <h4>Log In</h4>
            ...
            <form action="process.php" method="POST">
              <label for="1">Phone or Email:</label>
              <input type="number" class="weka1" placeholder="Phone/Email">
              </br>
              </br>
              <label for="2">Password:</label>
              <input type="password" class="weka2">
              </br>
              </br>
    ...
    <!--Sign Up-->
          <h4>Sign Up</h4>
          <a href="accounts/signup.php"> <button>Create Account</button> </a>
        </div>
      </div>
    </div>
